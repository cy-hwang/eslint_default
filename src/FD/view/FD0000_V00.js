...
afc.extendsClass(FD0000_V00, AView);


FD0000_V00.prototype.init = function(context, evtListener)
{
...
FD0000_V00.prototype.setDelegator = function(delegator)
{
	this.delegator = delegator;
};

//계좌번호 설정
FD0000_V00.prototype.doInitAccInfo = function(gejoaInfo, isNoTrigger)
{
...
FD0000_V00.prototype.onAccDbxSelect = function(comp, info)
{	
...
FD0000_V00.prototype.onSecureTxfChange = function(comp, info)
{
	var  thisObj = this		
