...
afc.extendsClass(FD0000_V02, AView);


FD0000_V02.prototype.init = function(context, evtListener)
{
...
FD0000_V02.prototype.setDelegator = function(delegator)
{
	this.delegator = delegator;
};

//계좌번호 설정
FD0000_V02.prototype.doInitAccInfo = function(gejoaInfo, isNoTrigger)
{
...
FD0000_V02.prototype.onAccDbxSelect = function(comp, info)
{	
...
FD0000_V02.prototype.doHideTitle = function()
{
