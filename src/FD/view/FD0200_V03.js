...
afc.extendsClass(FD0200_V03, AView);


FD0200_V03.prototype.init = function(context, evtListener)
{
...
FD0200_V03.prototype.resetView = function()
{	
...
FD0200_V03.prototype.onAgree1BtnClick = function(comp, info)
{
...
FD0200_V03.prototype.onAgree2BtnClick = function(comp, info)
{
...
FD0200_V03.prototype.onAgree3BtnClick = function(comp, info)
{
...
FD0200_V03.prototype.onAgree4BtnClick = function(comp, info)
{
...
FD0200_V03.prototype.onAgreeallCbxClick = function(comp, info)
{
	if(comp.getCheck()){
...
FD0200_V03.prototype.onAgreeCbxClick = function(comp, info)
{
...
//사용자 최종확인
FD0200_V03.prototype.confirmUser = function(callback)
{
