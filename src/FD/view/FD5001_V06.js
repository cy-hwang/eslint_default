...
afc.extendsClass(FD5001_V06, AView);


FD5001_V06.prototype.init = function(context, evtListener)
{
...
//화면이 활성화된 후 이벤트
FD5001_V06.prototype.onActiveDone = function(reload)
{
...
FD5001_V06.prototype.onButton1Click = function(comp, info)
{
...
//계좌정보 가져오기
FD5001_V06.prototype.requestAccountInfo = function()
{
	var thisObj = this;
	var cont = thisObj.getContainer();
