...
*/
function FD1201_W03(containerId)
{
...
afc.extendsClass(FD1201_W03, BaseWindow);

FD1201_W03.prototype.onReady = function()
{
...
FD1201_W03.prototype.init = function(context, evtListener)
{
...
FD1201_W03.prototype.onActiveDone = function(reload)
{
...
FD1201_W03.prototype.initFundInfo = function()
{
...
FD1201_W03.prototype.sendSACAQ501 = function()
{
	var thisObj = this;
...
FD1201_W03.prototype.setFundInfo = function(outBlock2)
{
	var thisObj = this;
...
FD1201_W03.prototype.onCancelBtnClick = function(comp, info)
{
	this.sendSACAT516();
};

//자동 이체 해지 신청
FD1201_W03.prototype.sendSACAT516 = function(){
...
FD1201_W03.prototype.onCloseBtnClick = function(comp, info)
{
	this.close(0);
};