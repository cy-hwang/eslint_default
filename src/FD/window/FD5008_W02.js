...
*/
function FD5008_W02(containerId)
{
	BaseWindow.call(this, containerId);
	
	this.cancelBtn = null;
}
afc.extendsClass(FD5008_W02, BaseWindow);


FD5008_W02.prototype.onReady = function()
{
...
FD5008_W02.prototype.onActiveDone = function(reload)
{
...
FD5008_W02.prototype.setBaseFundInfo = function()
{
	var thisObj = this;
...
//펀드 매매 취소
FD5008_W02.prototype.onCancelBtnClick = function(comp, info)
{
	//예약주문인 경우
	if(this.ifReserved) {
		this.sendSOFFT224();
...
//펀드 매매 취소
FD5008_W02.prototype.sendSOFFT131 = function(){
...
//펀드예약매매 취소
FD5008_W02.prototype.sendSOFFT224 = function(){
...
FD5008_W02.prototype.onCloseBtnClick = function(comp, info)
{
	this.close(0);
};