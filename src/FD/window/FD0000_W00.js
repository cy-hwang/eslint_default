...
function FD0000_W00(containerId)
{
...
afc.extendsClass(FD0000_W00, BaseWindow);


FD0000_W00.prototype.onReady = function()
{
...
//최초 실행
FD0000_W00.prototype.onInit = function()
{
...
FD0000_W00.prototype.onCloseBtnClick = function(comp, info)
{
	this.close(0);
};

FD0000_W00.prototype.onCancelBtnClick = function(comp, info)
{
	this.close(0);
};

FD0000_W00.prototype.onOkBtnClick = function(comp, info)
{
	this.close(1);
};
