...
*/
function FD5006_W02(containerId)
{
	AWindow.call(this, containerId);

	//# Set layout url like this ...
	//this.url = 'folderName/FD5006_W02.lay';

	//TODO:edit here

}
afc.extendsClass(FD5006_W02, AWindow);


FD5006_W02.prototype.onReady = function()
{
	...
	this.RdoTrsfBtn02 = this.findCompById('RdoTrsfBtn02');	// 매매
	this.RdoTrsfBtn03 = this.findCompById('RdoTrsfBtn03');	// 신청(주문)
	this.RdoTrsfBtn04 = this.findCompById('RdoTrsfBtn04');	// 입출금
	this.RdoTrsfBtns = [
		{ btnComp : this.RdoTrsfBtn01, btnVal : '0' },
		{ btnComp : this.RdoTrsfBtn02, btnVal : '3' },
		{ btnComp : this.RdoTrsfBtn03, btnVal : '7' },
		{ btnComp : this.RdoTrsfBtn04, btnVal : '1' }
	];		
...
// 컴포넌트 초기화
FD5006_W02.prototype.onInitComponents = function()
{
	// 조회기간 및 거래구분 셋팅
...
// 옵션에 따라 버튼 선택
FD5006_W02.prototype.onOptionBtnSelect = function(iIndex, tIndex)
{	
	// 조회기간
...
// 조회기간별 버튼 클릭 시
FD5006_W02.prototype.onInqryBtnClick = function(comp, info)
{
...
// DatePicker 활성화 처리
FD5006_W02.prototype.onDatePickerControl = function(isTrue)
{
...
FD5006_W02.prototype.onSetSelectInqryBtn = function()
{
...
// 선택된 거래구분의 타입 값 셋팅
FD5006_W02.prototype.onSetSelectRdoTrsfBtn = function()
{
...
// 확인 버튼 클릭
FD5006_W02.prototype.onBtnOkClick = function(comp, info)
{
	// 뷰로 넘겨줄 값 셋팅
...
// X 버튼 클릭
FD5006_W02.prototype.onBtnCloseClick = function(comp, info)
{
	this.close(0);
};
