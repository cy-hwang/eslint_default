...
AGridEvent.prototype._scroll = function()
{
	...
	{
		//scroll bottom
		//2018.12.06 HCY Chrome webview version 71이후부터 scrollTop 값 int > float
		if((this.offsetHeight +this.scrollTop - agrid.bodyTopBorderH) + 1 >= this.scrollHeight)
		{
...
//cell, row 이벤트 처리
AGridEvent.prototype._select = function(clkEle)
{
	if(!clkEle) return;
	var thisObj = this;
...
//cell, row 이벤트 처리
AGridEvent.prototype._longtab = function(clkEle)
{
	if(!clkEle) return;
	//var thisObj = this;
